...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/omnivore-app/omnivore/build-self-host-docker-images.yaml?branch=main)](https://github.com/omnivore-app/omnivore/actions/workflows/build-self-host-docker-images.yaml)
