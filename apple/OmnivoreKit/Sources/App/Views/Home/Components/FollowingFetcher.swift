...
// import Views
//
// @MainActor final class FollowingFetcher: NSObject, ObservableObject, LibraryItemFetcher {
//  var folder = "following"
//
...
//    )
//
//    let filter = LinkedItemFilter(rawValue: filterState.appliedFilter)
//
...
//      }()
//
//      print("RESULTS OF SEARCH: ", newItems)
//
//      if filterState.searchTerm.replacingOccurrences(of: " ", with: "").isEmpty, filter?.allowLocalFetch ?? false {
...
//
//    var query = "in:following \(sort.queryString)"
////    if !queryContainsFilter(filterState), let filter = LinkedItemFilter(rawValue: filterState.appliedFilter) {
...
// }
//
// extension FollowingFetcher: NSFetchedResultsControllerDelegate {
