...
extension Fields where TypeLock == Objects.Query {
  ...
  func articles<Type>(sharedOnly: OptionalArgument<Bool> = .absent(), sort: OptionalArgument<InputObjects.SortParams> = .absent(), after: OptionalArgument<String> = .absent(), first: OptionalArgument<Int> = .absent(), query: OptionalArgument<String> = .absent(), includePending: OptionalArgument<Bool> = .absent(), selection: Selection<Type, Unions.ArticlesResult>) throws -> Type {
    let field = GraphQLField.composite(
      name: "articles",
      arguments: [Argument(name: "sharedOnly", type: "Boolean", value: sharedOnly), Argument(name: "sort", type: "SortParams", value: sort), Argument(name: "after", type: "String", value: after), Argument(name: "first", type: "Int", value: first), Argument(name: "query", type: "String", value: query), Argument(name: "includePending", type: "Boolean", value: includePending)],
      selection: selection.selection
    )
    select(field)
...
extension Fields where TypeLock == Unions.UpdatePageResult {
  func on<Type>(updatePageSuccess: Selection<Type, Objects.UpdatePageSuccess>, updatePageError: Selection<Type, Objects.UpdatePageError>) throws -> Type {
    select([GraphQLField.fragment(type: "UpdatePageSuccess", selection: updatePageSuccess.selection), GraphQLField.fragment(type: "UpdatePageError", selection: updatePageError.selection)])
...
extension Fields where TypeLock == Unions.SetLabelsResult {
  func on<Type>(setLabelsSuccess: Selection<Type, Objects.SetLabelsSuccess>, setLabelsError: Selection<Type, Objects.SetLabelsError>) throws -> Type {
    select([GraphQLField.fragment(type: "SetLabelsSuccess", selection: setLabelsSuccess.selection), GraphQLField.fragment(type: "SetLabelsError", selection: setLabelsError.selection)])
...
extension Fields where TypeLock == Unions.SubscriptionsResult {
  func on<Type>(subscriptionsSuccess: Selection<Type, Objects.SubscriptionsSuccess>, subscriptionsError: Selection<Type, Objects.SubscriptionsError>) throws -> Type {
    select([GraphQLField.fragment(type: "SubscriptionsSuccess", selection: subscriptionsSuccess.selection), GraphQLField.fragment(type: "SubscriptionsError", selection: subscriptionsError.selection)])
    ...
    case .mocking:
      return subscriptionsSuccess.mock()
    }
  }
}
...
extension Fields where TypeLock == Unions.UnsubscribeResult {
  func on<Type>(unsubscribeSuccess: Selection<Type, Objects.UnsubscribeSuccess>, unsubscribeError: Selection<Type, Objects.UnsubscribeError>) throws -> Type {
    select([GraphQLField.fragment(type: "UnsubscribeSuccess", selection: unsubscribeSuccess.selection), GraphQLField.fragment(type: "UnsubscribeError", selection: unsubscribeError.selection)])
    ...
    case .mocking:
      return unsubscribeSuccess.mock()
    }
  }
}
...
extension Fields where TypeLock == Unions.SubscribeResult {
  func on<Type>(subscribeSuccess: Selection<Type, Objects.SubscribeSuccess>, subscribeError: Selection<Type, Objects.SubscribeError>) throws -> Type {
    select([GraphQLField.fragment(type: "SubscribeSuccess", selection: subscribeSuccess.selection), GraphQLField.fragment(type: "SubscribeError", selection: subscribeError.selection)])
...
extension Fields where TypeLock == Unions.AddPopularReadResult {
  func on<Type>(addPopularReadSuccess: Selection<Type, Objects.AddPopularReadSuccess>, addPopularReadError: Selection<Type, Objects.AddPopularReadError>) throws -> Type {
    select([GraphQLField.fragment(type: "AddPopularReadSuccess", selection: addPopularReadSuccess.selection), GraphQLField.fragment(type: "AddPopularReadError", selection: addPopularReadError.selection)])
    ...
    case .mocking:
      return addPopularReadSuccess.mock()
    }
  }
}
...
extension InputObjects {
  struct GenerateApiKeyInput: Encodable, Hashable {
    var scope: OptionalArgument<String> = .absent()

    var expiredAt: OptionalArgument<DateTime> = .absent()

    func encode(to encoder: Encoder) throws {
      var container = encoder.container(keyedBy: CodingKeys.self)
      if scope.hasValue { try container.encode(scope, forKey: .scope) }
      if expiredAt.hasValue { try container.encode(expiredAt, forKey: .expiredAt) }
    }
