...
require("mocha");
const process_youtube_video_1 = require("../../src/jobs/process-youtube-video");
describe('create transcript', () => {
    describe('build items', () => {
        it('properly adds chapter headers to transcript', async () => {
            ...
            const res = (0, process_youtube_video_1.addTranscriptChapters)(chapters, transcript);
            console.log('res: ', res);
            (0, chai_1.expect)(res.length).to.eq(17);
            (0, chai_1.expect)(res[13].text).to.eq("\n\n## Joe Biden's re-election effort\n\n");
        });
    });
});
