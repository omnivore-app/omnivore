...
const search_1 = require("../../src/utils/search");
describe('filterItemEvents', () => {
    it('returns events if there are quotation marks in the subscription name', () => {
        ...
        const ast = (0, search_1.parseSearchQuery)(query);
        const events = [
            {
                id: '1',
        ...
        const result = (0, library_item_1.filterItemEvents)(ast, events);
        (0, chai_1.expect)(result).to.eql(events);
    });
