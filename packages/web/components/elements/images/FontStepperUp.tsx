...
export function FontStepperUp(props: FontStepperUpProps): JSX.Element {
  return (
    ...
    >
      <path
        d="M34.2935 34.2954L21.7811 10.6606L9.26855 34.2954"
        stroke={props.color}
        strokeWidth="2.78055"
        strokeLinecap="round"
