...
export const OnboardingJoinCommunity = (
  props: OnboardingJoinCommunityProps
) => {
  return (
    <OnboardingLayout
          ...
          <VStack>
            <Row distribution="between">
              <IconContainer>
                <Icon
                  css={{ height: 60 }}
                  src="/static/images/onboarding/github.svg"
                  alt="Github Logo"
                />
              </IconContainer>
            ...
            <Row distribution="between">
              <IconContainer>
                <Icon
                  src="/static/images/onboarding/discord.svg"
                  alt="Discrod Logo"
                />
              </IconContainer>
            ...
            <Row distribution="between">
              <IconContainer>
                <Icon
                  css={{ width: 74, height: 67 }}
                  src="/static/images/onboarding/producthunt.svg"
