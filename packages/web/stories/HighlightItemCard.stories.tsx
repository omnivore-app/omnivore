...
} from '../components/patterns/LibraryCards/HighlightItemCard'
...
const highlight: HighlightItemCardProps = {
  ...
  item: {
    ...
    author: 'Author',
    image:
      'https://logos-world.net/wp-content/uploads/2021/11/Unity-New-Logo.png',
...
export const DarkHighlightItemCard: ComponentStory<typeof HighlightItemCard> = (
  args: any
) => {
